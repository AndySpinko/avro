...
public class incidentRegistration extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2366882681892805562L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"incidentRegistration\",\"namespace\":\"com.andy.avro\",\"doc\":\"Avro схема для передачи сервисам статуса регистрации их обращения в системе TaskFlow\",\"fields\":[{\"name\":\"header\",\"type\":\"string\",\"doc\":\"Служебный заголовок события\"},{\"name\":\"sndType\",\"type\":\"string\",\"doc\":\"Идентификации типа события и соответствующей ему схемы\"},{\"name\":\"sndVersion\",\"type\":\"string\",\"doc\":\"Версия схемы события\"},{\"name\":\"sndDate\",\"type\":{\"type\":\"long\",\"logicalType\":\"local-timestamp-micros\"},\"doc\":\"Дата отправки события источником\"},{\"name\":\"prevEvtID\",\"type\":\"string\",\"doc\":\"ID предыдущего события в потоке событий источника\",\"default\":\"NONE\"},{\"name\":\"signature\",\"type\":\"string\",\"doc\":\"системная подпись\"}]}");
  ...
  private static final BinaryMessageEncoder<incidentRegistration> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<incidentRegistration> DECODER =
   ...
   */
  public static BinaryMessageEncoder<incidentRegistration> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<incidentRegistration> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<incidentRegistration> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this incidentRegistration to a ByteBuffer.
  ...
  /**
   * Deserializes a incidentRegistration from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a incidentRegistration instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static incidentRegistration fromByteBuffer(
   ...
   */
  public incidentRegistration(java.lang.CharSequence header, java.lang.CharSequence sndType, java.lang.CharSequence sndVersion, java.time.LocalDateTime sndDate, java.lang.CharSequence prevEvtID, java.lang.CharSequence signature) {
    this.header = header;
  ...
  /**
   * Creates a new incidentRegistration RecordBuilder.
   * @return A new incidentRegistration RecordBuilder
   */
  public static com.andy.avro.incidentRegistration.Builder newBuilder() {
    return new com.andy.avro.incidentRegistration.Builder();
  }

  /**
   * Creates a new incidentRegistration RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new incidentRegistration RecordBuilder
   */
  public static com.andy.avro.incidentRegistration.Builder newBuilder(com.andy.avro.incidentRegistration.Builder other) {
    if (other == null) {
      return new com.andy.avro.incidentRegistration.Builder();
    } else {
      return new com.andy.avro.incidentRegistration.Builder(other);
    }
  }

  /**
   * Creates a new incidentRegistration RecordBuilder by copying an existing incidentRegistration instance.
   * @param other The existing instance to copy.
   * @return A new incidentRegistration RecordBuilder
   */
  public static com.andy.avro.incidentRegistration.Builder newBuilder(com.andy.avro.incidentRegistration other) {
    if (other == null) {
      return new com.andy.avro.incidentRegistration.Builder();
    } else {
      return new com.andy.avro.incidentRegistration.Builder(other);
  ...
  /**
   * RecordBuilder for incidentRegistration instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<incidentRegistration>
    implements org.apache.avro.data.RecordBuilder<incidentRegistration> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.andy.avro.incidentRegistration.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing incidentRegistration instance
     * @param other The existing instance to copy.
     */
    private Builder(com.andy.avro.incidentRegistration other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = data().deepCopy(fields()[0].schema(), other.header);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setHeader(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearHeader() {
      header = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setSndType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearSndType() {
      sndType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setSndVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearSndVersion() {
      sndVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setSndDate(java.time.LocalDateTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearSndDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setPrevEvtID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearPrevEvtID() {
      prevEvtID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder setSignature(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.andy.avro.incidentRegistration.Builder clearSignature() {
      signature = null;
    ...
    public incidentRegistration build() {
      try {
        incidentRegistration record = new incidentRegistration();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<incidentRegistration>
    WRITER$ = (org.apache.avro.io.DatumWriter<incidentRegistration>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<incidentRegistration>
    READER$ = (org.apache.avro.io.DatumReader<incidentRegistration>)MODEL$.createDatumReader(SCHEMA$);
